...
<title>InboxOro — SMTP Sandbox</title>
...
/* ── Sidebar ── */
const sidebar=document.getElementById('sidebar'),backdrop=document.getElementById('sb-backdrop'),
      toggleBtn=document.getElementById('sb-toggle-btn'),collapseBtn=document.getElementById('sb-collapse-btn');
