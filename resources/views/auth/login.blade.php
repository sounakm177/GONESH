...
<div class="topbar">
  ...
  <div class="topbar-right">
    ...
    <a class="top-btn" href="{{ route('register') }}">Create Account →</a>
  </div>
</div>
...
<div class="page">
  ...
  <div class="form-panel">
    <div class="form-wrap">
      ...
      <div class="or-row">OR CONTINUE WITH EMAIL</div>
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <div class="field">
          ...
          <div class="field-wrap">
            <input class="field-input @error('login') is-invalid @enderror" id="login" type="text" name="login" value="{{ old('login') }}" placeholder="you@example.com" autocomplete="username" autofocus />
        ...
        <div class="field">
          ...
          <div class="field-wrap">
            <input class="field-input @error('password') is-invalid @enderror" id="password" type="password" name="password" placeholder="Enter your password" autocomplete="current-password" />
        ...
        <button class="btn-submit" id="login-btn" type="submit">
          <span id="btn-txt">Sign In to InboxOro</span>
        </button>
      </form>

      <div class="legal">By signing in you agree to our <a href="/terms">Terms</a> and <a href="/privacy-policy">Privacy Policy</a>.</div>
    </div>
  </div>
</div>
